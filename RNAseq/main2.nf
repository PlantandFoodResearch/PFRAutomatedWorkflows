 ...
 */
params.reads ="/workspace/cfpcxs/KiwiTestData/*.R{1,2}.fq"
params.annot = "/workspace/cfpcxs/KiwiTestData/kiwitest.gff3"
params.genome = "/workspace/cfpcxs/KiwiTestData/kiwitest.fasta"
...
process qualitycontrol {
	...
	publishDir params.outdir
        ...
        output:
        set "*.zip", "*.html" into qualitycontrolR
